...
export const isSupportedSocialProvider = (provider: unknown): provider is SupportedSocialProvider =>
  typeof provider === 'string' && supportedSocialProviders.includes(provider as SupportedSocialProvider)
