...
INSERT INTO "new_Repository" ("companyId", "id", "integrationId", "owner", "projectId", "provider", "repo") SELECT "companyId", "id", "integrationId", "owner", "projectId", "provider", "repo" FROM "Repository";
