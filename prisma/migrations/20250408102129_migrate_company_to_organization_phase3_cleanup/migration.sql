...
INSERT INTO "new_company_github_users" ("created_at", "display_name", "email", "login", "name", "organization_id", "picture_url", "updated_at", "user_id") SELECT "created_at", "display_name", "email", "login", "name", "company_id" as "organization_id", "picture_url", "updated_at", "user_id" FROM "company_github_users";
...
INSERT INTO "new_export_settings" ("client_email", "created_at", "id", "organization_id", "private_key", "sheet_id", "updated_at") SELECT "client_email", "created_at", "id", "company_id" as "organization_id", "private_key", "sheet_id", "updated_at" FROM "export_settings";
...
INSERT INTO "new_integrations" ("id", "method", "organization_id", "private_token", "provider") SELECT "id", "method", "company_id" as "organization_id", "private_token", "provider" FROM "integrations";
...
INSERT INTO "new_repositories" ("created_at", "id", "integration_id", "organization_id", "owner", "provider", "release_detection_key", "release_detection_method", "repo", "updated_at") SELECT "created_at", "id", "integration_id", "company_id" as "organization_id", "owner", "provider", "release_detection_key", "release_detection_method", "repo", "updated_at" FROM "repositories";
