...
upflow が計測しようとしているものの「業界文脈」と「具体策」を、ベンダー中立な形で整理した場所。RDD で「この設計判断は業界実践のどこに位置するか」を引用するための参照点。

- [practices/](./practices/) — 一覧は [practices/README.md](./practices/README.md)
  - `pr-flow/` — PR を速く流す (PR サイズ・段階的 PR・マージキュー・初回レビュー SLA)
  - `code-review/` — レビューをまっとうにする (AI と人間の役割分担・質の仕掛け)
  - `metrics/` — 計測する (DORA・SPACE/DevEx・AI 生産性のパラドックス)
