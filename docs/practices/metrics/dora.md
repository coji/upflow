...
| Continuous delivery              | ✅   | [delivery/continuous-delivery.md](../delivery/continuous-delivery.md)                                                                   |
| Continuous integration           | ✅   | [delivery/continuous-integration.md](../delivery/continuous-integration.md) (関連: [pr-flow/merge-queue.md](../pr-flow/merge-queue.md)) |
| Database change management       | ⚪   | upflow の計測対象外。Atlas 運用は CLAUDE.md 参照                                                                                        |
| Deployment automation            | ✅   | [delivery/deployment-automation.md](../delivery/deployment-automation.md)                                                               |
...
| Test automation                  | ✅   | [delivery/test-automation.md](../delivery/test-automation.md)                                                                           |
| Test data management             | ⚪   | テスト領域。本書スコープ外                                                                                                              |
| Trunk-based development          | ✅   | [delivery/trunk-based-development.md](../delivery/trunk-based-development.md)                                                           |
...
- ✅ 専用ファイル: 5 (Continuous delivery / Continuous integration / Deployment automation / Test automation / Trunk-based development — すべて `delivery/` 配下)
- 🟡 部分対応: 7
- ⚪ 当面扱わない: 22

`delivery/` 配下の 5 ファイルは DORA 能力名と 1 対 1 で対応する。一方 `pr-flow/` 配下のファイル ([pr-size-discipline.md](../pr-flow/pr-size-discipline.md) 等) は複数の DORA 能力を横断する形で書いている。「PR サイズ規律」は DORA で言う `Code maintainability` + `Working in small batches` + `Streamlining change approval` の交点に位置する。
