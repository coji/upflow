...
- 200-400 行の PR は 400 行超に比べ **欠陥 40% 少ない**
- 200-400 行の PR は **承認が 3 倍速い**
- 400 行を超えると、欠陥検出率と承認速度の両方が急落する
...
jtcc データでは、XS (50行未満) の PR は長尾発生率 6%、XL (1000行+) は 17% と、サイズと長尾発生率に明確な正の相関がある (issue #332 の調査参照)。
...
- [Stacked Pull Requests - The Complete Guide](https://www.awesomecodereviews.com/best-practices/stacked-prs/) — 1.5 万件分析の引用元
