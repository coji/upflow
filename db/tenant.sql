...
-- Create "repository_installation_memberships" table (installation ↔ repository visibility)
...
-- Create index "repository_installation_memberships_installation_id_idx"
...
-- Create "pr_title_filters" table (display-only exclusion filter by PR title substring)
...
-- Create unique index "pr_title_filters_normalized_pattern_key" to table: "pr_title_filters"
